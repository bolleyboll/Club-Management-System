...
public class viewmemaro extends javax.swing.JFrame {

   
    public viewmemaro() {
        initComponents();
        showuser();
        this.setSize(810, 572);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("THE MEMBERS BELONGING TO YOUR CLUB ARE");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(110, 10, 610, 58);
        ...
        jScrollPane1.setBounds(160, 120, 453, 338);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewmemaro().setVisible(true);
            }
        });
    }
